...
- Results of using LCR & conductance to classify test set predictions of the 3 CNN (trained over their 3 respective datasets) are displayed in the following table:
